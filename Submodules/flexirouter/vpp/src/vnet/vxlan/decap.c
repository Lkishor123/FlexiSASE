 ...
 *  3. After finding vxlan-tunnel, packet was being passed to l2-input without
 *     checking if enough bytes for L2 header is present. Fix is to check L2
 *     header length before passing packet to l2-input node
 *
