...
static fwabf_quality_service_tolerance_t service_class_quality[] = {
 ...
 {FWABF_QUALITY_SC_SIGNALING,                 FWABF_QUALITY_LEVEL_LOW,         FWABF_QUALITY_LEVEL_LOW,          FWABF_QUALITY_LEVEL_YES},
 {FWABF_QUALITY_SC_NETWORK_CONTROL,           FWABF_QUALITY_LEVEL_LOW,         FWABF_QUALITY_LEVEL_LOW,          FWABF_QUALITY_LEVEL_YES},
