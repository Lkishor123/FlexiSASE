...
#define foreach_mss_clamp_error		 \
 _(CLAMPED, "MSS clamped")

typedef enum
{
#define _(sym,str) MSS_CLAMP_ERROR_##sym,
  foreach_mss_clamp_error
#undef _
    MSS_CLAMP_N_ERROR,
} mss_clamp_error_t;

static char *mss_clamp_error_strings[] = {
#define _(n,s) s,
  foreach_mss_clamp_error
#undef _
};
...
VLIB_REGISTER_NODE (mssc_ip4_in_node) =
{
  ...
  .error_strings = mss_clamp_error_strings,
